...
if (isset($_POST['update_id']) && isset($_POST['status']) && !isset($_POST['add_note'])) {
    ...
    // Only update status, do not add note
...
<body>
    <div class="admin-header">
        ...
        <a href="admin.php" class="back-link">&larr; Back to Admin Portal</a>
    </div>
